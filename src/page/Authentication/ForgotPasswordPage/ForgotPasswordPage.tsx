          ...
          <div className="space-y-6">
            ...
            <ScrollAnimation type="slide" direction="up" delay={0.3}>
              <p className="text-slate-600 text-sm md:text-base">
                Không sao cả! Chúng tôi sẽ giúp bạn lấy lại quyền truy cập vào tài khoản của mình.
                Nhập email của bạn và chúng tôi sẽ gửi cho bạn liên kết đặt lại mật khẩu.
              </p>
            </ScrollAnimation>
