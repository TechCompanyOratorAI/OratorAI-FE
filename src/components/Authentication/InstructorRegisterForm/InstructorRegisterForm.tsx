...
const InstructorRegisterForm: React.FC = () => {
      ...
      <div className="bg-white/80 backdrop-blur border border-slate-100 shadow-xl shadow-sky-100/40 rounded-2xl p-6 md:p-8">
        <ScrollAnimation type="fade" delay={0.3}>
          <h2 className="text-xl font-semibold text-slate-900 mb-2">
            Đăng ký tài khoản Instructor
          </h2>
        </ScrollAnimation>
        <ScrollAnimation type="fade" delay={0.4}>
          <p className="text-sm text-slate-500 mb-6">
            Tạo tài khoản Instructor để quản lý khóa học và đánh giá bài thuyết trình của sinh viên.
          </p>
        </ScrollAnimation>
